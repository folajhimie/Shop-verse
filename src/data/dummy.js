...
import rating from '../static/rating.jpg'
...
export const gridOrderImage = (props) => (
  <div>
    <img
      className="rounded-xl h-20 md:ml-3 w-6/12"
...
export const EditorData = () => (
  <div>
    <h3>
      ...
      Online Playgrounds
      If you’re interested in playing around with React, you can use an online code playground. Try a Hello World template on Code Pen, Code Sandbox, or Stack blitz.
      ...
      React for Beginners
      If you feel that the React documentation goes at a faster pace than you’re comfortable with, check out this overview of React by Tania Rashia. It introduces the most important React concepts in a detailed, beginner-friendly way. Once you’re done, give the documentation another try!
...
export const chatData = [
  ...
  },
  {
    id:5,
    image:avatar2,
    message: 'Daniel Added To The Whatsapp Group',
    desc: 'Assign her to become the Group Admin',
    time: '4:18 AM',
  },
];
...
export const scheduleData = [
  ...
  {
    Id: 25,
    Subject: 'Getting My PVC',
    Location: 'Lagos',
    StartTime: '2021-01-12T07:00:00.000Z',
    EndTime: '2021-01-12T09:00:00.000Z',
    CategoryColor: '#7fa900',
  },
];
...
export const KanbanData = [
  ...
  },
  {
    ...
    Title: 'Task - 23801',
    Status: 'Open',
    Summary: 'Zenith is optimized for learning and training. Examples might be simplified to improve reading and learning.',
    Type: 'Story',
    Priority: 'High',
    Tags: 'Fix,Client',
    Estimate: 0.5,
    Assignee: 'Nancy Isime',
    RankId: 4,
    Color: '#02897B',
    ClassName: 'e-story, e-low, e-nancy-davloio',
  },
